...
export default function ProtectedLayout() {
  ...
  const isDashboardPath = ['/dashboard', '/admin', '/history', '/extension', '/ats', '/linkedin-optimizer', '/interview-prep', '/resume', '/settings', '/profile'].some(p => location.pathname.startsWith(p));
